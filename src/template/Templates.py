class AgreementTemplate():
    ...
    def __init__(self):
        self.rules = {
            ...
            'obj_rel_across_inanim': (['D', 'IS', 'IC', 'D', 'ES', 'EV',
                                       'IV'], {
                                           'match': ([1], [6]),
                                           'vary': [4, 5]
                                       }),
            'obj_rel_within_inanim': (['D', 'IS', 'IC', 'D', 'ES', 'EV',
                                       'IV'], {
                                           'match': ([4], [5]),
                                           'vary': [1, 6]
                                       }),
            ...
            'obj_rel_no_comp_across_anim': (['D', 'MS', 'D', 'ES', 'EV',
                                             'MV'], {
                                                 'match': ([1], [5]),
                                                 'vary': [3, 4]
                                             }),
            'obj_rel_no_comp_within_anim': (['D', 'MS', 'D', 'ES', 'EV',
                                             'MV'], {
                                                 'match': ([3], [4]),
                                                 'vary': [1, 5]
                                             }),
...
class NPITemplate():
    ...
    def __init__(self):
        self.rules = {
            'npi_across_anim':
                (['NO', 'MS', 'C', 'D', 'ES', 'EV', 'PASTAUX', 'NPI',
                  'APMV'], None),
            'npi_across_inanim':
                (['NO', 'IS', 'C', 'D', 'ES', 'EV', 'PASTAUX', 'NPI',
                  'IPMV'], None),
